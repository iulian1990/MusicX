...
class PlaylistSongListFragmentDirections private constructor() {
    private data class ActionPlaylistSongListFragmentToPlayingFragment(val trackCatalog:
            TrackCatalog, val startTrackIndex: Int = 0) : NavDirections {
        override fun getActionId(): Int = R.id.action_playlistSongListFragment_to_playingFragment
    ...
    companion object {
        fun actionPlaylistSongListFragmentToPlayingFragment(trackCatalog: TrackCatalog,
                startTrackIndex: Int = 0): NavDirections =
                ActionPlaylistSongListFragmentToPlayingFragment(trackCatalog, startTrackIndex)
    }
}
