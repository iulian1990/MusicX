...
class AlbumSongListFragmentDirections private constructor() {
    private data class ActionAlbumSongListFragmentToPlayingFragment(val trackCatalog: TrackCatalog,
            val startTrackIndex: Int = 0) : NavDirections {
        override fun getActionId(): Int = R.id.action_albumSongListFragment_to_playingFragment
    ...
    companion object {
        fun actionAlbumSongListFragmentToPlayingFragment(trackCatalog: TrackCatalog,
                startTrackIndex: Int = 0): NavDirections =
                ActionAlbumSongListFragmentToPlayingFragment(trackCatalog, startTrackIndex)
    }
}
